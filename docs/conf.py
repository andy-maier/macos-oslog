#
# Sphinx config file for macos-oslog project.
#
...
def get_version(version_file):
    ...
    with open(version_file, 'r') as fp:
        for line in fp:
            ...
            raise ValueError("Could not find version in {}".format(version_file))
...
project = u'macos-oslog'
copyright = u'Copyright 2022 Andreas Maier. All Rights Reserved.'
author = u"Andreas Maier"

# The short description of the package.
_short_description = u"Python bindings for the unified logging and tracing system of macOS"
...
version = get_version(os.path.join('..', 'src', 'macos_oslog.c'))
...
exclude_patterns = ["README.rst", ".tox", ".git", "design", "tests", "dist",
                    "build_doc"]
...
htmlhelp_basename = 'macos_oslog_doc'
...
latex_documents = [
    (master_doc, 'macos_oslog.tex', _short_description, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'macos_oslog', _short_description, [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'macos_oslog', _short_description,
     author, 'macos_oslog', _short_description,
     'Miscellaneous'),
]
