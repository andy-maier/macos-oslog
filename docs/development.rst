...
The repository for the macos-oslog project is on GitHub:
...
1. If you have write access to the Git repo of this project, clone it using
   ...
   .. code-block:: bash
        ...
        $ git clone git@github.com:andy-maier/macos-oslog.git
        $ cd macos-oslog
...
Python environment.
Depending on how the `macos_oslog` package is installed in
...
This section describes how to release a version of macos-oslog
to PyPI.
...
The description assumes that the `andy-maier/macos-oslog`
Github repo is cloned locally and its upstream repo is assumed to have the Git
remote name `origin`.

Any commands in the following steps are executed in the main directory of your
local clone of the `andy-maier/macos-oslog`
Git repo.
...
macos-oslog project in its Git repo.
...
3.  Edit the version file:
    ...
    .. code-block:: C
        ...
        static const char *__version__ = "M.N.U.dev1";
